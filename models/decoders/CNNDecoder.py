...
class CNNHead(nn.Module):
    def __init__(self,
        ...
        self.PointConv1 = PointConv(in_dim=F1_in_channels, out_dim=embedding_dim)
        self.PointConv2 = PointConv(in_dim=F2_in_channels, out_dim=embedding_dim)
        self.PointConv3 = PointConv(in_dim=F3_in_channels, out_dim=embedding_dim)
        self.PointConv4 = PointConv(in_dim=F4_in_channels, out_dim=embedding_dim)
