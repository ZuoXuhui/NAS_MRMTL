...
from ..net_utils import PCASC as PCASC
from ..net_utils import IGMAVC as IGMAVC
...
class RGBXTransformerBlock(nn.Module):
    def __init__(self, img_size=224, patch_size=3, stride=2, depths=4, in_chans=3, num_classes=9, 
        ...
        self.patch_embed2 = OverlapPatchEmbed(img_size=img_size, patch_size=patch_size, stride=stride, in_chans=in_chans,
                                              embed_dim=embed_dims)
